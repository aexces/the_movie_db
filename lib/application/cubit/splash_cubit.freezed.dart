...
class _$SplashStateTearOff {
  ...
  _SplashState call({required bool enabled}) {
    return _SplashState(
      enabled: enabled,
    );
  }
...
class _$_SplashState implements _SplashState {
  const _$_SplashState({required this.enabled});
  ...
  @override
  String toString() {
    return 'SplashState(enabled: $enabled)';
  }
...
abstract class _SplashState implements SplashState {
  const factory _SplashState({required bool enabled}) = _$_SplashState;
